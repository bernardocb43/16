...
class PokedexApp(tk.Tk):
    ...
    def criar_interface(self):
        ...
        subtitle = ttk.Label(self, text="🍷🗿", style="Title.TLabel")
        subtitle.pack(pady=(100, 10))
        ...
        self.info_label = ttk.Label(container, text="", justify="center", font=("Segoe UI", 11),
                                    wraplength=600, foreground="black", background="#FAFAFA")
        self.info_label.pack(pady=10)

        self.extra_info = ttk.Label(container, text="", justify="center", font=("Segoe UI", 10, "italic"),
                                    wraplength=600, foreground="black", background="#FAFAFA")
        self.extra_info.pack(pady=5)

        self.evo_label = ttk.Label(container, text="", justify="center", font=("Segoe UI", 10),
                                   wraplength=600, foreground="#555", background="#FAFAFA")
        self.evo_label.pack(pady=10)

        self.footer_label = ttk.Label(self, text="Desenvolvido com (GOOGLE)✅ e Tkinter❌",
                                      font=("Segoe UI", 9, "italic"), background="#B22222", foreground="white")
    ...
    def selecionar_sugestao(self, event):
        if self.sugestoes_listbox.curselection():
            selecionado = self.sugestoes_listbox.get(self.sugestoes_listbox.curselection())
    ...
    def tocar_som_url(self, nome_pokemon):
        url = f"https://play.pokemonshowdown.com/audio/cries/{nome_pokemon.lower()}.mp3"
            ...
            try:
                ...
                if resposta.status_code == 200:
                    ...
                    with tempfile.NamedTemporaryFile(delete=False, suffix=".mp3") as tmpfile:
                        tmpfile.write(resposta.content)
